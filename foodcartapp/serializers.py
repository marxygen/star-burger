...
class OrderedItemSerializer(serializers.ModelSerializer):
    product = serializers.PrimaryKeyRelatedField(required=True, queryset=Product.objects.available())
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ordered_items = [OrderedItem.objects.create(**entity) for entity in validated_data.pop('ordered_items')]
